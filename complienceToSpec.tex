...
\toprule
\rowcolor{lightgray}
Requirement & Complience & Requirement & Complience\\
\midrule
1 (a) &  Not tested but assumed to function properly. & 2 (e) &  It should be easy to implement a autonomous operating system. \\
\midrule
1 (b) &  The RBRs needed to be adjustable, and are also constucted that fashion. & 2 (f) &  Not tested but assumed to not be fulfilled. \\
\midrule
...
\midrule
2 (c) &  No occuring problems when the RBRs are rotating. & 6 &  A successful test was performed, with the local newspaper filming. \\
\midrule
