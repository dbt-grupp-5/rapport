...
%In this study the capacity of different materials (concrete, zeolite, goethite, ion exchange and activated carbon) to adsorb metal ions in polluted water over time was investigated. The material were added in SpinChem\textsuperscript{\textregistered}'s rotating bed reactors (RBR). The materials were sieved (300-700~$\mu$m) and washed in deionized water before studied. The concentration of metal ions (copper and zinc) was measured by the analytic methods FAAS and ICP-OES.
...
The result for the pH measurements using concrete and goethite in polluted water containing metal ions, looked to be stable at pH~5 for goethite during the whole time interval (\cref{tab:ph}). However, for concrete, the pH rose from 5 to 10 the first 5~minutes and then rose to 12 after 120~minutes. 
